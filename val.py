...
# 评估模型效果
# python val.py --data mask_data.yaml --weights runs/train/exp_yolov5s/weights/best.pt --img 640
# python val.py --data posture_data.yaml --weights runs/train/exp8/weights/best.pt --img 640
# python val.py --data safe_data.yaml --weights runs/train/exp5/weights/best.pt --img 640
